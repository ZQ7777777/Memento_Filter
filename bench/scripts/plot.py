...
RANGE_FILTERS_STYLE_KWARGS = {"memento": {"marker": '4', "color": "fuchsia", "zorder": 11, "label": "Memento"},
                              ...
                              "self1": {"marker": 'P', "color": "darkred", "zorder": 12, "label": "PCF_CNT2(ALPHA=0.01)"},
                              "self2": {"marker": 'p', "color": "dimgray", "zorder": 12, "label": "PCF_CNT2(ALPHA=0.015)"},
                              "self3": {"marker": 'o', "color": "tan", "zorder": 12, "label": "PCF_CNT2(ALPHA=0.02)"},
