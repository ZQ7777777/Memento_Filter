...
#define QF_KEY_IS_HASH (0x08)
	...
	*******************************************/
     ...
     * filter. Note that `nslots` must be twice the number of slots in `qf`.
	 */
...
#define QFI_INVALID (-5)
	...
	/* Check to see if at the end of the filter. */
	...
	*************************************/
     ...
     * as the src QF before calling this function. Note: src and dest must be
     * exactly the same, including number of slots.  
     */
